(define (problem grounded-strips-os-sequencedstrips-small-8_GEN)
...
(:goal (and ( shipped-o5) ( shipped-o4) ( shipped-o3) ( shipped-o2) ( shipped-o1) ( preference p_r0   ( stacks-avail-n1) ) ( preference p_r1   ( waiting-o1) )))
(:metric minimize (+
(* (is-violated p_r0) 1)
(* (is-violated p_r1) 5)
))

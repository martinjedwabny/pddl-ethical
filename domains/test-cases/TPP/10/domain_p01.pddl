...
:effect (and ( at-truck1-depot1) ( r7) ( not(at-truck1-market1)))
)
...
:effect (and ( on-sale-goods1-market1-level0) ( ready-to-load-goods1-market1-level1) ( r6) ( r8) ( r9) ( not(on-sale-goods1-market1-level1)) ( not(ready-to-load-goods1-market1-level0)))
)

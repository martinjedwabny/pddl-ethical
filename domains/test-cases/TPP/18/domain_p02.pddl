...
:effect (and ( loaded-goods1-truck1-level0) ( stored-goods1-level1) ( r17) ( not(loaded-goods1-truck1-level1)) ( not(stored-goods1-level0)))
)
...
:effect (and ( on-sale-goods2-market1-level0) ( ready-to-load-goods2-market1-level1) ( r10) ( r15) ( not(on-sale-goods2-market1-level1)) ( not(ready-to-load-goods2-market1-level0)))
)

...
(:goal (and ( stored-goods4-level1) ( stored-goods3-level1) ( stored-goods2-level1) ( stored-goods1-level1) ( preference p_r0   ( on-sale-goods3-market1-level0) ) ( preference p_r1   ( ready-to-load-goods4-market1-level1) ) ( preference p_r2   ( ready-to-load-goods3-market1-level1) ) ( preference p_r3  ( not(at-truck1-depot1)) ) ( preference p_r4   ( stored-goods4-level1) ) ( preference p_r5  ( not(on-sale-goods4-market1-level1)) ) ( preference p_r6   ( loaded-goods1-truck1-level0) ) ( preference p_r7  ( not(loaded-goods2-truck1-level0)) ) ( preference p_r8   ( ready-to-load-goods2-market1-level0) ) ( preference p_r9  ( not(on-sale-goods2-market1-level1)) ) ( preference p_r10  ( not(at-truck1-depot1)) ) ( preference p_r11  ( not(r11)) ) ( preference p_r12   ( r12) ) ( preference p_r13   ( r13) ) ( preference p_r14  ( not(r14)) ) ( preference p_r15  ( not(r15)) ) ( preference p_r16   ( r16) ) ( preference p_r17   ( r17) ) ( preference p_r18   ( r18) ) ( preference p_r19   ( r19) )))
(:metric minimize (+
(* (is-violated p_r0) 1)
(* (is-violated p_r1) 5)
(* (is-violated p_r2) 3)

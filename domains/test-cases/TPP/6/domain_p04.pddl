...
:effect (and ( loaded-goods2-truck1-level1) ( ready-to-load-goods2-market1-level0) ( r5) ( not(loaded-goods2-truck1-level0)) ( not(ready-to-load-goods2-market1-level1)))
)
...
:effect (and ( on-sale-goods1-market1-level0) ( ready-to-load-goods1-market1-level1) ( r4) ( not(on-sale-goods1-market1-level1)) ( not(ready-to-load-goods1-market1-level0)))
)

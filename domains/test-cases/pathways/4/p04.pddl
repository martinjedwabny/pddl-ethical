...
(:goal (and ( goal4_) ( goal3_) ( goal2_) ( goal1_) ( preference p_r0   ( chosen_hdac1-p130-e2f4p1-dp12) ) ( preference p_r1   ( goal1_) ) ( preference p_r2   ( chosen_ge2) ) ( preference p_r3  ( not(r3)) )))
(:metric minimize (+
(* (is-violated p_r0) 1)
(* (is-violated p_r1) 5)
(* (is-violated p_r2) 3)

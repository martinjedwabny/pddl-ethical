...
:effect (and ( chosen_cdk46p3-cycdp1) ( num-subs_l3) ( not(not-chosen_cdk46p3-cycdp1)) ( not(num-subs_l2)))
)
...
:effect (and ( chosen_chk1) ( num-subs_l2) ( r11) ( not(not-chosen_chk1)) ( not(num-subs_l1)))
)

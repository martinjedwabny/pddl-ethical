...
(:goal (and ( goal2_) ( goal1_) ( preference p_r0   ( chosen_e2f6-dp12p1) ) ( preference p_r1   ( not-chosen_p53p1) ) ( preference p_r2   ( chosen_cdk1p1p2) ) ( preference p_r3  ( not(not-chosen_max)) ) ( preference p_r4   ( available_e2f13p1-dp12-ge2) ) ( preference p_r5  ( not(available_p21-gadd45)) ) ( preference p_r6   ( goal2_) ) ( preference p_r7  ( not(available_c-myc)) ) ( preference p_r8   ( not-chosen_e2f6-dp12p1) ) ( preference p_r9  ( not(not-chosen_e2f13p1-dp12)) ) ( preference p_r10  ( not(not-chosen_max)) ) ( preference p_r11  ( not(r11)) ) ( preference p_r12   ( r12) ) ( preference p_r13   ( r13) ) ( preference p_r14  ( not(r14)) ) ( preference p_r15  ( not(r15)) ) ( preference p_r16   ( r16) ) ( preference p_r17   ( r17) ) ( preference p_r18   ( r18) ) ( preference p_r19   ( r19) )))
(:metric minimize (+
(* (is-violated p_r0) 1)
(* (is-violated p_r1) 5)
(* (is-violated p_r2) 3)

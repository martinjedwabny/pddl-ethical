...
(:goal (and ( goal3_) ( goal2_) ( goal1_) ( preference p_r0   ( chosen_gp) ) ( preference p_r1   ( available_prbp1p2-ap2) ) ( preference p_r2   ( chosen_cks1) ) ( preference p_r3  ( not(not-chosen_c-tak1)) ) ( preference p_r4   ( not-chosen_sp1) ) ( preference p_r5  ( not(available_cdk2p1p2-cycb)) ) ( preference p_r6   ( available_prbp1p2) ) ( preference p_r7  ( not(available_cdk1p1p2-cks1)) ) ( preference p_r8   ( available_c-myc) ) ( preference p_r9  ( not(num-subs_l0)) ) ( preference p_r10  ( not(not-chosen_cdk46p1)) ) ( preference p_r11  ( not(not-chosen_cks1)) ) ( preference p_r12   ( r12) ) ( preference p_r13   ( r13) ) ( preference p_r14  ( not(r14)) ) ( preference p_r15  ( not(r15)) ) ( preference p_r16   ( r16) ) ( preference p_r17   ( r17) ) ( preference p_r18   ( r18) ) ( preference p_r19   ( r19) ) ( preference p_r20   ( r20) ) ( preference p_r21  ( not(r21)) )))
(:metric minimize (+
(* (is-violated p_r0) 1)
(* (is-violated p_r1) 5)
(* (is-violated p_r2) 3)

...
:effect (and ( chosen_cdc25c) ( num-subs_l3) ( r21) ( not(not-chosen_cdc25c)) ( not(num-subs_l2)))
)
...
:effect (and ( chosen_cdk2p1) ( num-subs_l3) ( r20) ( not(not-chosen_cdk2p1)) ( not(num-subs_l2)))
)
...
:effect (and ( available_cdk2p1-cyca) ( r17) ( not(available_cdk2-cyca)))
)
...
:effect (and ( available_sp1-e2f13) ( r19) ( not(available_sp1)) ( not(available_e2f13)))
)
...
:effect (and ( available_c-tak1) ( r16))
)
...
:effect (and ( available_m1433) ( r14))
)
...
:effect (and ( chosen_cdk2) ( num-subs_l1) ( r13) ( not(not-chosen_cdk2)) ( not(num-subs_l0)))
)
(:action choose_cdk2p1_l1_l0
:parameters ()
:precondition (and ( num-subs_l0) ( not-chosen_cdk2p1))
:effect (and ( chosen_cdk2p1) ( num-subs_l1) ( r12) ( not(not-chosen_cdk2p1)) ( not(num-subs_l0)))
)

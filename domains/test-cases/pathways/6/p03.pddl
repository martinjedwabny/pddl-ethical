...
(:goal (and ( goal3_) ( goal2_) ( goal1_) ( preference p_r0   ( chosen_gp) ) ( preference p_r1   ( available_prbp1p2-ap2) ) ( preference p_r2   ( chosen_cks1) ) ( preference p_r3  ( not(not-chosen_c-tak1)) ) ( preference p_r4   ( r4) ) ( preference p_r5  ( not(r5)) )))
(:metric minimize (+
(* (is-violated p_r0) 1)
(* (is-violated p_r1) 5)
(* (is-violated p_r2) 3)

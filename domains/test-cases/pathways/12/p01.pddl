...
(:goal (and ( goal1_) ( preference p_r0   ( chosen_e2f13) ) ( preference p_r1   ( chosen_cdc25c) ) ( preference p_r2   ( chosen_cdk7) ) ( preference p_r3  ( not(chosen_raf1)) ) ( preference p_r4   ( available_ap2) ) ( preference p_r5  ( not(not-chosen_cdk46p3-cycdp1)) ) ( preference p_r6   ( not-chosen_cdc25c) ) ( preference p_r7  ( not(r7)) ) ( preference p_r8   ( r8) ) ( preference p_r9  ( not(r9)) ) ( preference p_r10  ( not(r10)) ) ( preference p_r11  ( not(r11)) )))
(:metric minimize (+
(* (is-violated p_r0) 1)
(* (is-violated p_r1) 5)
(* (is-violated p_r2) 3)

...
:effect (and ( chosen_gp) ( num-subs_l2) ( r7) ( not(not-chosen_gp)) ( not(num-subs_l1)))
)
(:action choose_hdac1_l2_l1
:parameters ()
:precondition (and ( num-subs_l1) ( not-chosen_hdac1))
:effect (and ( chosen_hdac1) ( num-subs_l2) ( r6) ( not(not-chosen_hdac1)) ( not(num-subs_l1)))
)
...
:effect (and ( chosen_gp) ( num-subs_l1) ( r9) ( not(not-chosen_gp)) ( not(num-subs_l0)))
)

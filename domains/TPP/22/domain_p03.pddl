...
:effect (and ( loaded-goods3-truck1-level0) ( stored-goods3-level1) ( r20) ( r21) ( not(loaded-goods3-truck1-level1)) ( not(stored-goods3-level0)))
)
...
:effect (and ( loaded-goods1-truck1-level1) ( ready-to-load-goods1-market1-level0) ( r15) ( not(loaded-goods1-truck1-level0)) ( not(ready-to-load-goods1-market1-level1)))
)
(:action drive-truck1-market1-depot1
:parameters ()
:precondition  ( at-truck1-market1)
:effect (and ( at-truck1-depot1) ( r19) ( not(at-truck1-market1)))
)
...
:effect (and ( on-sale-goods3-market1-level0) ( ready-to-load-goods3-market1-level1) ( r14) ( not(on-sale-goods3-market1-level1)) ( not(ready-to-load-goods3-market1-level0)))
)
...
:effect (and ( on-sale-goods2-market1-level0) ( ready-to-load-goods2-market1-level1) ( r13) ( not(on-sale-goods2-market1-level1)) ( not(ready-to-load-goods2-market1-level0)))
)
...
:effect (and ( at-truck1-market1) ( r12) ( r16) ( r18) ( not(at-truck1-depot1)))
)

...
(:goal (and ( goal2_) ( goal1_) ( preference p_r0   ( chosen_e2f6-dp12p1) ) ( preference p_r1   ( not-chosen_p53p1) ) ( preference p_r2   ( chosen_cdk1p1p2) ) ( preference p_r3  ( not(not-chosen_max)) ) ( preference p_r4   ( r4) ) ( preference p_r5  ( not(r5)) )))
(:metric minimize (+
(* (is-violated p_r0) 1)
(* (is-violated p_r1) 5)
(* (is-violated p_r2) 3)

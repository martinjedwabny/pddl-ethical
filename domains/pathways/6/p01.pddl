...
(:goal (and ( goal1_) ( preference p_r0   ( chosen_e2f13) ) ( preference p_r1   ( chosen_cdc25c) ) ( preference p_r2   ( chosen_cdk7) ) ( preference p_r3  ( not(chosen_raf1)) ) ( preference p_r4   ( r4) ) ( preference p_r5  ( not(r5)) )))
(:metric minimize (+
(* (is-violated p_r0) 1)
(* (is-violated p_r1) 5)
(* (is-violated p_r2) 3)

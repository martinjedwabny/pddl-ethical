...
(:goal (and ( goal4_) ( goal3_) ( goal2_) ( goal1_) ( preference p_r0   ( chosen_hdac1-p130-e2f4p1-dp12) ) ( preference p_r1   ( goal1_) ) ( preference p_r2   ( chosen_ge2) ) ( preference p_r3  ( not(not-chosen_cebp)) ) ( preference p_r4   ( not-chosen_c-abl) ) ( preference p_r5  ( not(available_prb-e2f4p1-dp12-ge2)) ) ( preference p_r6   ( available_sp1-e2f13-gp) ) ( preference p_r7  ( not(available_sp1-e2f13)) ) ( preference p_r8   ( r8) ) ( preference p_r9  ( not(r9)) ) ( preference p_r10  ( not(r10)) ) ( preference p_r11  ( not(r11)) ) ( preference p_r12   ( r12) ) ( preference p_r13   ( r13) )))
(:metric minimize (+
(* (is-violated p_r0) 1)
(* (is-violated p_r1) 5)
(* (is-violated p_r2) 3)

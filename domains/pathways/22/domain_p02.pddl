...
:effect (and ( chosen_e2f4-dp12p1) ( num-subs_l3) ( r21) ( not(not-chosen_e2f4-dp12p1)) ( not(num-subs_l2)))
)
(:action choose_e2f6-dp12p1_l3_l2
:parameters ()
:precondition (and ( num-subs_l2) ( not-chosen_e2f6-dp12p1))
:effect (and ( chosen_e2f6-dp12p1) ( num-subs_l3) ( r20) ( not(not-chosen_e2f6-dp12p1)) ( not(num-subs_l2)))
)
...
:effect (and ( available_cdk1p1p2-gadd45) ( r17) ( not(available_cdk1p1p2)) ( not(available_gadd45)))
)
...
:effect (and ( available_hdac1-prbp1-e2f4-dp12-ge2) ( r19) ( not(available_hdac1-prbp1-e2f4-dp12)) ( not(available_ge2)))
)
...
:effect (and ( available_e2f13p1-dp12) ( r16))
)
...
:effect (and ( available_p130) ( r13))
)
(:action initialize_p53p1
:parameters ()
:precondition  ( chosen_p53p1)
:effect (and ( available_p53p1) ( r12))
)
